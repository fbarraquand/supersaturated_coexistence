...
For the first numerical experiment, introducing species one after the other as in the original simulation, the following statistics, displaying the proportion (expressed in \%) of experiments with $X$ species present at different times of the simulation, could be obtained:

\input{../Code/Figures/results_exp2}
