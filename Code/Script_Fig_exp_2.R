...
Fig_exp2 <- subplot(Fig_exp2_1, Fig_exp2_2, Fig_exp2_3, Fig_exp2_4, Fig_exp2_5, Fig_exp2_6, Fig_exp2_7, Fig_exp2_8, Fig_exp2_9, Fig_exp2_10, Fig_exp2_11, Fig_exp2_12, Fig_exp2_13, Fig_exp2_14, Fig_exp2_15, Fig_exp2_16, 
  ...
  layout(showlegend=F, 
         ...
         annotations = list(list( 
           x = 0,   
           y = 1,   
           text = paste("a)",stats_exp2[FigList[1], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0,   
           y = 0.725,   
           text = paste("b)",stats_exp2[FigList[1], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.25,   
           y = 1, 
           text = paste("a)",stats_exp2[FigList[2], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.25,   
           y = 0.725, 
           text = paste("b)",stats_exp2[FigList[2], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.5,   
           y = 1,   
           text = paste("a)",stats_exp2[FigList[3], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.5,   
           y = 0.725,   
           text = paste("b)",stats_exp2[FigList[3], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.75,   
           y = 1,   
           text = paste("a)",stats_exp2[FigList[4], 1]), 
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.75,   
           y = 0.725,   
           text = paste("b)",stats_exp2[FigList[4], 1]), 
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0,   
           y = 0.475,   
           text = paste("a)",stats_exp2[FigList[5], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0,   
           y = 0.225,   
           text = paste("b)",stats_exp2[FigList[5], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.25,   
           y = 0.475,   
           text = paste("a)",stats_exp2[FigList[6], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.25,   
           y = 0.225,   
           text = paste("b)",stats_exp2[FigList[6], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.5,   
           y = 0.475,   
           text = paste("a)",stats_exp2[FigList[7], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.5,   
           y = 0.225,   
           text = paste("b)",stats_exp2[FigList[7], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.75,   
           y = 0.475,   
           text = paste("a)",stats_exp2[FigList[8], 1]), 
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.75,   
           y = 0.225,   
           text = paste("b)",stats_exp2[FigList[8], 1]), 
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
