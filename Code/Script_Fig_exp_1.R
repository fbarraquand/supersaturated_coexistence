...
Fig_exp1 <- subplot(Fig_exp1_1, Fig_exp1_2, Fig_exp1_3, Fig_exp1_4, Fig_exp1_5, Fig_exp1_6, Fig_exp1_7, Fig_exp1_8, Fig_exp1_9, Fig_exp1_10, Fig_exp1_11, Fig_exp1_12, Fig_exp1_13, Fig_exp1_14, Fig_exp1_15, Fig_exp1_16, 
  ...
  layout(showlegend = F, 
         ...
         annotations = list(list( 
           x = 0,   
           y = 1,   
           text = paste("a)",stats_exp1[FigList[1], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0,   
           y = 0.725,   
           text = paste("b)",stats_exp1[FigList[1], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.25,   
           y = 1, 
           text = paste("a)",stats_exp1[FigList[2], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.25,   
           y = 0.725, 
           text = paste("b)",stats_exp1[FigList[2], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.5,   
           y = 1,   
           text = paste("a)",stats_exp1[FigList[3], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.5,   
           y = 0.725,   
           text = paste("b)",stats_exp1[FigList[3], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.75,   
           y = 1,   
           text = paste("a)",stats_exp1[FigList[4], 1]), 
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.75,   
           y = 0.725,   
           text = paste("b)",stats_exp1[FigList[4], 1]), 
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0,   
           y = 0.475,   
           text = paste("a)",stats_exp1[FigList[5], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0,   
           y = 0.225,   
           text = paste("b)",stats_exp1[FigList[5], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.25,   
           y = 0.475,   
           text = paste("a)",stats_exp1[FigList[6], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.25,   
           y = 0.225,   
           text = paste("b)",stats_exp1[FigList[6], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.5,   
           y = 0.475,   
           text = paste("a)",stats_exp1[FigList[7], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.5,   
           y = 0.225,   
           text = paste("b)",stats_exp1[FigList[7], 1]),   
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.75,   
           y = 0.475,   
           text = paste("a)",stats_exp1[FigList[8], 1]), 
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
         ...
         list( 
           x = 0.75,   
           y = 0.225,   
           text = paste("b)",stats_exp1[FigList[8], 1]), 
           xref = "paper",   
           yref = "paper",   
           xanchor = "center",   
           yanchor = "bottom",   
